...
- 当前 Work Package：M0.5-WP03 — GitHub Actions CI。
...
M0.5-WP03 GitHub Actions CI：为 PR 配置既有本地验证命令的自动检查。禁止直接 push main、force push、自动 merge、共享分支 rebase、远程历史重写、生产服务/数据库/n8n 配置变更；出现远程分叉、权限异常、敏感文件风险或 CI 配置无法验证时必须停止。
